...
export const site = {
  ...
  keywords: [
    "homoeopathy",
    "homeopathy",
    "homoeopathic clinic Rajkot",
    "homoeopathic doctor Rajkot Gujarat",
    "Dr. Sumant Zankat",
    ...
    "gentle healing homeopathy",
    "homeopathy for children Rajkot",
    "homeopathy for women health",
    "homeopathy for hair loss",
    "homeopathy for allergies",
    "homeopathy for digestion problems",
  ],
